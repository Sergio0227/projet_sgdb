...
if ($element->fetchOne() && $element->putData()) {
    echo json_encode(array('message' => 'Element update', 'request' => array('type' => 'GET', 'url' => 'http://localhost/sgdb_api/elements.php?id=' .$id)));
} else {
